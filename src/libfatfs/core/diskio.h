...
DSTATUS disk_initialize (FFS_U8);
DSTATUS disk_status (FFS_U8);
DRESULT disk_read (FFS_U8, FFS_U8*, uint32_t, FFS_U8);
#if   _READONLY == 0
DRESULT disk_write (FFS_U8, const FFS_U8*, uint32_t, FFS_U8);
#endif
DRESULT disk_ioctl (FFS_U8, FFS_U8, void*);
#else
#include "../inc/fatfs_diskio.h"
